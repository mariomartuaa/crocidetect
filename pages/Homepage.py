...
st.markdown(f"""
<h1 style="font-size: clamp(14px, 3vw, 20px); color: #2e5339; margin-left: 5rem; margin-right: 5rem; text-align: justify;">Sebuah instar adalah sebuah tahap perkembangan pada artropoda seperti serangga. Perbedaan diantara instar umumnya dapat dilihat dari perubahan ukuran tubuh, warna, pola, jumlah segmen tubuh, dan lebar kepala.</h1>""", unsafe_allow_html=True)
