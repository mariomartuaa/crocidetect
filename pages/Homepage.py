...
st.markdown(f'<h1 style="text-align: center; font-size: 20px; color: #2e5339; margin-left:5rem; margin-right:5rem;">Sebuah instar adalah sebuah tahap perkembangan pada artropoda seperti serangga. Perbedaan diantara instar umumnya dapat dilihat dari perubahan ukuran tubuh, warna, pola, jumlah segmen tubuh, dan lebar kepala.</h1>', unsafe_allow_html=True)
...
for i in range(4):
    with cols[i]:
        st.markdown(f'<h1 style="font-size: 20px; color: #2e5339;">{instar_data[i]["title"]}</h1>', unsafe_allow_html=True)
